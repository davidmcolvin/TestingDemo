...
namespace DemoLibrary.Tests
{
  public class DataAccessTests
  {
    ...
    public void AddPersonToPeopleList_ShouldFail(string firstName, string lastName, string parameter)
    {
      PersonModel newPerson = new PersonModel { FirstName = firstName, LastName = lastName };
      List<PersonModel> people = new List<PersonModel>();

      Assert.Throws<ArgumentException>(parameter, () => DataAccess.AddPersonToPeopleList(people, newPerson));
    }
  }
}
